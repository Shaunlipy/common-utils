...
# class names
class_names = ['hkq','ljg','lq','ydc','wsc','ryc','pcc','qyc','kcm_k','kcm_g','hcm_k','hcm_g','xlct','xlcx','xlcsd','ktc','ybc']
...
def detect_onnx(official=True, image_path=None):
    ...
    session = onnxruntime.InferenceSession('/Volumes/CT500/Researches/torchserve_example/airport/artefacts/model-11-10.onnx')
...
def display(detections=None, image_path=None, line_thickness=None, text_bg_alpha=0.0):
    ...
    for i, box in enumerate(boxs):
        ...
        cv2.rectangle(image_src, (x1, y1), (x2, y2), color, 2)
...
if __name__ == '__main__':
    ...
    t1 = time.time()
    image_path = '/Volumes/CT500/Researches/torchserve_example/airport/test1.jpg'
    with torch.no_grad():
    ...
    t3 = time.time()
    print(f'total: {t3 - t1:.5f}, inf: {t2 - t1:.5f}, draw: {t3 - t2:.5f}')
